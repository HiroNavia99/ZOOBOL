...
<div class="container-fluid">
  <div class="row">
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
	  ...
	  <h1 class="h2">Añadir Publicacion</h1>
        <h6><?php 
	...
	<form method="post" enctype="multipart/form-data">
		...
		Nombre de Publicacion:<input type="text" name="post_title" minlength="15" maxlength="50" class="form-control"   placeholder="Introduce Nombre del Post"><br>
		
		Categoria:<select name="post_category" class="form-control" id="exampleFormControlSelect1">
		<?php
		...
		Contenido de la publicacion:<textarea name="post_content" class="form-control" id="exampleFormControlTextarea1"rows="3"></textarea><br>
		
		Imagen:<input type="file" name="file" class="form-control-file" id="exampleFormControlFile1"><br>
		
		Palabras Clave o HashTags:<input type="text" name="post_keyword" class="form-control"   placeholder="Introduce clave o #"><br>
