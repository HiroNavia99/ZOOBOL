...
<div class="container-fluid">
  <div class="row">
	...
	<form method="post" enctype="multipart/form-data">
		...
		Nombre de Pestaña:<input type="text" name="page_title" class="form-control"   placeholder="Introduce el titulo de la Pestaña" value="<?php echo $pageTitle;?>"><br>
		
		Contenido Pestaña:<textarea name="page_content" class="form-control" id="exampleFormControlTextarea1"rows="5"><?php echo $pageContent; ?></textarea><br>
		
		
		<button type="submit" name="update" class="btn btn-primary">Actualizar Pestaña</button>
