...
<html lang="en">
<head>
	<title>Todas las Pestañas</title>
  ...
  <div class="row">
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Pestañas</h1>
        <center><h6> <?php 
		echo $_SESSION['author_name'];
		?> | Logueado como: <?php echo $_SESSION['author_role'];?></h6></center>
		<button id="toggleForm" class="btn btn-info">Agregar Pestaña</button>
      </div>
	...
	<div id="admin-index-form">
		...
		<h4>Todas las Pestañas</h4><br>
		
		<div style="display:none" id="newPageForm">
		
		<form action="newpage.php" method="post">
		<input type="text" name="page_title" class="form-control" placeholder="Introduce nombre de la Pestaña"><br>
		<textarea name="page_content" class="form-control" placeholder="Enter Page Content"rows="5"></textarea><br>
		<button name="submit" class="btn btn-success">Agregar Pestaña</button>
		</form><br>
		...
		<table class="table">
			  <thead>
				<tr>
				  <th scope="col">Nro de Pestaña:</th>
				  <th scope="col">Nombre Pestaña:</th>
	...
	?>
				<tr>
				  ...
				  <td>
				  <a href="editpage.php?id=<?php echo $page_id;?>"><button class="btn btn-info">Editar</button></a>
				  
				  <a onClick="return confirm('Are You Sure?');" href="deletepage.php?id=<?php echo $page_id;?>"><button class="btn btn-danger">Eliminar</button></a>
				  </td>
