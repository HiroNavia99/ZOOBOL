...
<div class="container-fluid">
  <div class="row">
	...
	<div id="admin-index-form">
		...
		<h4>Encabezado Principal</h4><br>
		
		<form method="post">
		Nombre del Encavezado
		<input type="text" name="home_jumbo_title" class="form-control" placeholder="Intoruce un Nombre para tu Encabezado" value="<?php getSettingValue("home_jumbo_title") ?>"><br>
		
		Descripcion del encabezado
		<input type="text" name="home_jumbo_desc" class="form-control" placeholder="Descripcion o informacion" value="<?php getSettingValue("home_jumbo_desc") ?>"><br>
