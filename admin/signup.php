...
<body>
	...
	<h1 class="h3 mb-3 font-weight-normal"><b>Registrate ya nomas!!</b></h1>
	<input type="text" name="author_name" id="input" class="form-control" placeholder="Introduce tu Nombre Completo"autofocus><br>
	
	<input type="email" name="author_email"  id="inputEmail" class="form-control" placeholder="Direccion de Correo Electronico"  autofocus><br>
	
	<input type="password" name="author_password" id="inputPassword" class="form-control" placeholder="Password" ><br>
	<button class="btn btn-lg btn-primary btn-block" name="signup" type="submit">Registrate!!</button>
</form>
