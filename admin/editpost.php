...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap  shadow">
	<a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="post.php">ZooBol</a>
  ...
  <div class="row">
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Editar Publicacion</h1>
        <h6> <?php 
	...
	<form method="post" enctype="multipart/form-data">
		...
		Nombre Publicacion:<input type="text" name="post_title" minlength="15" maxlength="50" class="form-control"   placeholder="Introduce el nombre" value="<?php echo $postTitle;?>"><br>
		
		Contenido Publicacion:<textarea name="post_content" class="form-control" id="exampleFormControlTextarea1"rows="5"><?php echo $postContent; ?></textarea><br>
		
		<img src="../<?php echo $postImage;?>" width="180px"height="150px"><br>
		
		Imagen:<input type="file" name="file" class="form-control-file" id="exampleFormControlFile1"><br>
		
		Palabra Clave o HashTag:<input type="text" name="post_keyword" class="form-control"   placeholder="Introduce los #" value="<?php echo $postKeyword;?>"><br>

		<button type="submit" name="update" class="btn btn-primary">Actualizar Publicacion</button>
	</form>
		<?php } ?>
		<?php
