...
<html lang="en">
<head>
	<title><?php echo $_SESSION['author_role'];?> Panel de Control</title>
...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap  shadow">
	...
	<a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#"><b>ZooBol</b></a>
  ...
  <div class="row">
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		...
		?> Logueado Como <?php echo $_SESSION['author_role'];?></h6>
      </div>
	<?php 
	...
	?>
		...
		<form method="post">
		Nombre Completo:<input name="author_name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Introduce tu nombre" value="<?php echo $_SESSION['author_name'];?>"><br>
		Email:<input name="author_email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Introduce tu Email" value="<?php echo $_SESSION['author_email'];?>">
		<small id="emailHelp" class="form-text text-muted">No compartimos tu informacion con nadie</small><br>
		Password:<input name="author_password" type="password" class="form-control" id="exampleInputPassword1" placeholder="Introduce tu Contraseña"><br>
		Tu Descripcion:<textarea name="author_bio" class="form-control" id="exampleInputPassword1" rows="3"><?php echo $_SESSION['author_bio'];?></textarea><br>
