...
<center>
	...
	<form method="post" class="form-signin">
	 <img class="imagen" src="/bg/head.jpg">
	<h1 class="h3 mb-3 font-weight-normal"><b>Porfavor Inicia Sesion</b></h1>
	
	<input type="email" name="author_email"  id="inputEmail" class="form-control" placeholder="Introduce Tu Correo Electronico"  autofocus><br>
	
	<input type="password" name="author_password" id="inputPassword" class="form-control" placeholder="Introduce tu Contraseña o Password" ><br>
