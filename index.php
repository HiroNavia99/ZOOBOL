...
<body>
	...
	<!--<center>
	<iframe width="700" height="200" src="https://www.youtube.com/embed/gVYjlmB81Hc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</center>-->
	...
	<div class="card-body">
		...
		<a href="post.php?id=<?php echo $post_id ;?>" class="btn btn-primary">Ver mas</a>
	</div>
